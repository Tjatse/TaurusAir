...
- (void)setIsSelected:(BOOL)isSelected
{
    ...
    self.imageView.image = (isSelected) ? [self renderMark] : [self renderCircle];
}
...
- (UIImage *)renderMark
{
    [self setContextSize:kMarkImageSize];
...
- (UIImage *)renderCircle
{
    UIBezierPath *unselectedCircle = [UIBezierPath bezierPathWithOvalInRect:kCircleRect]; // Unselected circle centered
